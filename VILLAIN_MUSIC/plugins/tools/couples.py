...
#BOT FILE NAME
from VILLAIN_MUSIC import app as app
from VILLAIN_MUSIC.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="Z᧐r᧐",
            url=f"https://t.me/UrZoroO",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "VILLAIN_MUSIC/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "VILLAIN_MUSIC/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("VILLAIN_MUSIC/assets/cppic.png")
